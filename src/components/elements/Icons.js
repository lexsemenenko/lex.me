...
const printSVGinner = passedName => {
  switch (passedName) {
    ...
    case 'google-doc':
      return (
        <path fill="currentColor" d="M93 50h314c24 0 43 19 43 43v314c0 24-19 43-43 43H93c-24 0-43-19-43-43V93c0-24 19-43 43-43zm46 135l222-1v-45H139zm0 88h222v-46H139zm0 88h156v-46H139z"/>
      );
    case 'logo':
      return (
        <path
